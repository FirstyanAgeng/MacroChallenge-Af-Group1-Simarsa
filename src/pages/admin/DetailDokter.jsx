                ...
                <Card.Body>
                    ...
                    <Row>
                        <Col sm={6}>
                            ...
                            <Card.Body>
                                <Card.Text>
                                    <h4 className="hw"><strong>dr.Wahyu Mustiadi, Sp.P. M. Kes</strong></h4>
                        ...
                        <Form.Control placeholder="dr.Wahyu Mustiadi, Sp.P. M. Kes" disabled />
                        </Form.Group>
                        <Form.Group className="tab1 mb-3">
                        ...
                        <Form.Control placeholder="Jl. Soekarno Hatta, Kota Jambi" disabled />
                        </Form.Group>
                        <Form.Group className="tab1 mb-3">
                        <Form.Label className="bold ">Tempat, Tanggal Lahir</Form.Label>
                        <Form.Control placeholder="Kota Jambi, 17 maret 1989" disabled />
                        </Form.Group>
                        <Form.Group className="tab1 mb-3">
                        ...
                        <Form.Control placeholder="08.00 - 11.00" disabled />
                        </Form.Group>
                        <Form.Group className="tab1 mb-3">
                        ...
                        <Form.Control placeholder="09.00 - 11.00" disabled />
                        </Form.Group>
                        <Button className="km2">Edit</Button>
                        </Tab>

            ...
            <Container className="containerDataPasien container mb-4">
                ...
                <Container>
                    ...
                    <Nav className="me-auto">
                        ...
                        <Nav.Link href={DATA_POLI}>Data Pasien</Nav.Link><AiOutlineRight className="ho1"/>
                ...
                <Container className="container-fluid mb-5">
                    <Row>
                        ...
                        <Form.Group className="mb-3 tab1">
                            ...
                            <Form.Control  placeholder="Terindikasi ditinggal ayang" as="textarea" rows={4} />
                        </Form.Group>
                        ...
                        <Form.Group className="mb-3 tab1">
                            ...
                            <Form.Control  placeholder="Paracetamol" as="textarea" rows={4} />
                        </Form.Group>

                        <Form.Group className="mb-3 tab1">
                            <Form.Label className="bold">Diagnosa</Form.Label>
                            <Form.Control  placeholder="cardiomyopathy" as="textarea" rows={4} />
                        </Form.Group>
